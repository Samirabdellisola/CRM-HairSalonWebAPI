...
public class ActivateBranchExecutor : BranchExecutorBase, IActivateBranchExecutor
{
    public ActivateBranchExecutor(AppDbContext dbContext, IBranchScopeChecker branchScopeChecker)
