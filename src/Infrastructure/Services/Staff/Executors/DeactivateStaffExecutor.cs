...
public class DeactivateStaffExecutor : StaffExecutorBase, IDeactivateStaffExecutor
{
    public DeactivateStaffExecutor(AppDbContext dbContext, IBranchScopeChecker branchScopeChecker)
